...
backup-files:
	docker exec bookstackphp tar -czvf bookstack-files-backup.tar.gz .env public/uploads storage/uploads
	docker cp bookstackphp:/var/www/html/bookstack-files-backup.tar.gz files/bookstack-files-backup.tar.gz
restore-files:
